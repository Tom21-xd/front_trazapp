...
const adminNavigation = [
  ...
  { name: 'Etapas', href: '/stages', icon: StagesIcon },
  { name: 'Etiquetas', href: '/tags', icon: TagIcon },
  { name: 'Tipos de proyecto', href: '/project-types', icon: ProjectTypeIcon },
  { name: 'Auditoría', href: '/audit', icon: AuditIcon },
];
...
function NavContent({ pathname, isAdmin, onClose }: NavContentProps) {
  return (
    <>
  ...
  return (
    <>
      ...
      >
        ...
        <NavContent pathname={pathname} isAdmin={isAdmin} onClose={onClose} />
      </aside>
